            ...
            <div className="space-y-8 text-right">
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-gray-700 leading-relaxed text-lg">
                    הרעיון לפרוייקט נולד לאחר שזיהינו מספר אתגרים מרכזיים שסטודנטים נתקלים בהם: קושי באיתור חומרי לימוד איכותיים, חוסר במידע מרוכז על מתרגלים וקורסים, והצורך בכלים פרקטיים לניהול הלימודים. במקום שכל סטודנט יצטרך לחפש מידע במקורות שונים ומפוזרים, החלטנו ליצור פלטפורמה אחת שתרכז את כל המידע הנחוץ.
                  </p>
                  <p className="text-gray-700 leading-relaxed text-lg">
                    ...
                    {[
                      ...
                      >
                        ...
                        <div className="relative z-10 flex flex-col items-center justify-center h-full">
                          ...
                          <span className="text-blue-600 font-bold text-xl md:text-2xl">{stat.מספר}</span>
                          <span className="text-gray-600 text-xs text-center">{stat.תיאור}</span>
                        </div>
                      </motion.div>
                    ))}
                  </div>
            ...
            <div className="relative h-[500px] mt-4">
              {loading ? (
                ...
                <>
                  {/* Avatar positions */}
                  {[
                    { top: '0%', left: '35%', zIndex: 10, delay: 0.3 },
                    { top: '5%', right: '5%', zIndex: 20, delay: 0.5 },
                    { top: '30%', right: '0%', zIndex: 30, delay: 0.7 },
                    { top: '58%', right: '2%', zIndex: 10, delay: 0.9 },
                    { top: '75%', left: '50%', zIndex: 20, delay: 1.1 },
                    { top: '63%', left: '18%', zIndex: 30, delay: 1.3 },
                    { top: '40%', left: '5%', zIndex: 10, delay: 1.5 },
                    { top: '15%', left: '5%', zIndex: 20, delay: 1.7 },
                    { top: '23%', right: '35%', zIndex: 30, delay: 1.9 },
                    { top: '47%', left: '47%', zIndex: 10, delay: 2.1 }
                  ].map((position, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          <div className="w-20 h-20 md:w-16 md:h-16 rounded-full overflow-hidden border-2 border-blue-200 shadow-md group-hover:shadow-blue-300 group-hover:scale-125 transition-all duration-500 ease-in-out">
                            <img 
              ...
              <motion.div 
                ...
                transition={{ duration: 1, delay: 0.2 }}
                className="absolute top-[15%] right-[45%] w-40 h-40 rounded-full bg-gradient-to-br from-blue-100 to-blue-200 z-0"
              />
              <motion.div 
                ...
                className="absolute top-[45%] right-[15%] w-36 h-36 rounded-full bg-gradient-to-br from-blue-200 to-blue-300 z-0"
              />
              <motion.div 
                ...
                className="absolute top-[65%] left-[20%] w-28 h-28 rounded-full bg-gradient-to-br from-blue-100 to-blue-200 z-0"
              />
              <motion.div 
                initial={{ scale: 0, opacity: 0, y: -10 }}
                animate={{ 
                ...
                className="absolute top-[25%] left-[25%] w-38 h-38 rounded-full bg-gradient-to-br from-blue-100 to-blue-200 z-0"
              />
              <motion.div 
                ...
                className="absolute top-[5%] right-[25%] w-28 h-28 rounded-full bg-gradient-to-br from-blue-100 to-blue-300 z-0"
              />
              <motion.div 
                initial={{ scale: 0, opacity: 0, y: -5 }}
                animate={{ 
                ...
                className="absolute bottom-[15%] right-[30%] w-24 h-24 rounded-full bg-gradient-to-br from-blue-200 to-blue-300 z-0"
              />
              <motion.div 
                ...
                className="absolute top-[40%] right-[30%] w-28 h-28 rounded-full bg-gradient-to-br from-blue-50 to-blue-200"
              />
